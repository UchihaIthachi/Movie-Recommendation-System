...
\title{\textbf{Assignment 2 -- Recommender System Algorithms and Computational Optimizations}\\
\large CS4553 -- Scientific Computing}

\author{210167E -- Fernando T.H.L.}
...
The optimized implementation is available in the GitHub repository:

\begin{center}
\url{https://github.com/UchihaIthachi/Movie-Recommendation-System}
\end{center}

To reproduce the work, clone the repository and move into the project directory:

\begin{verbatim}
git clone https://github.com/UchihaIthachi/Movie-Recommendation-System.git
cd Movie-Recommendation-System
\end{verbatim}

The final selected optimized single-threaded build can be compiled using:

\begin{verbatim}
gcc -O3 -march=native ui.c kmeans.c matrix_normalization.c pearsons.c \
    predictions.c recommender.c sorting.c utility_matrix.c \
    -o recsys_opt_st -lm
\end{verbatim}
...
The program opens an interactive menu where an existing user ID, such as
\texttt{1}, can be used to request movie predictions. The first recommendation
request is treated as the \textit{Cold Run}, because it includes loading and
initialization. Later requests in the same process are treated as
\textit{Warm Runs}, because cached data structures are reused.

More detailed reproduction steps, including benchmark execution, correctness
verification, dataset analysis, graph generation, and report building, are
provided in the project README.\footnote{
\url{https://github.com/UchihaIthachi/Movie-Recommendation-System/blob/master/README.md}
}
